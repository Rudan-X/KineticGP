...
ggplot(df, aes(y=Predicted,x=Measured, color=Season,shape=Season)) +
  ...
  stat_cor(method="pearson",cor.coef.name = "r",label.y.npc = 0, label.x.npc = 0,show.legend = FALSE) +
  coord_cartesian(ylim = c(10, 33) ) +
...
ggsave(paste0("Figures/SFsec5.2_BGLR_field.png"),width =6, height = 6)

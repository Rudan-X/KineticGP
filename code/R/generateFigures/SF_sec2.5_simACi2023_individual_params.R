...
df_meas <- melt(t(Aprofiles[,18:28]))
...
df <- df[df$A<50000,]
df$Condition <- gsub("X2023_CO2_","",df$Condition)

cond <- c("25","75", "100", "200", "250", "300",
          "400", "600", "800", "1000", "1250")
...
ggsave('figures/SFsec2.5_simulatedACi2023_individual_params.png',width=8,height = 11)

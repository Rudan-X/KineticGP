...
ecnumb{1}='4.2.1.1';
enzymes{1}='Carbonic anhydrase (CA)';

reactions{2}='2. HCO3->PEP+OAA [MC]';
ecnumb{2}='4.1.1.31';
enzymes{2}='Phosphoenolpyruvate carboxylase (PEPC)';

reactions{3}='3. OAA+NADPH->MAL+NADP [MCchl]';
ecnumb{3}='1.1.1.82';
enzymes{3}='Malate dehydrogenase (MDH)';

reactions{4}='4. MAL+NADP->CO2+PYR+NADPH [BCchl]';
ecnumb{4}='1.1.1.40';
enzymes{4}='NADP-Malic enzyme (ME)';

reactions{5}='5. PYR+ATP->PEP [MCchl]';
ecnumb{5}='2.7.9.1';
enzymes{5}='Pyruvate, phosphate dikinase (PPDK)';
...
ecnumb{7}='2.7.2.3';
enzymes{7}='Phosphoglycerate kinase (PGAK)';

reactions{8}='8. DPGA+NADPH->GAP+Pi+NADP [BCchl]';
ecnumb{8}='1.2.1.13';
enzymes{8}='Glyceraldehyde-3-phosphate dehydrogenase';

reactions{9}='9. GAP<->DHAP [BCchl]';
ecnumb{9}='5.3.1.1';
enzymes{9}='Triose-phosphate isomerase';

reactions{10}='10. DHAP+GAP<->FBP [BCchl]';
ecnumb{10}='4.1.2.13';
enzymes{10}='Fructose-bisphosphate aldolase';

reactions{11}='11. FBP<->F6P+Pi [BCchl]';
ecnumb{11}='3.1.3.11';
enzymes{11}='Fructose-bisphosphatase';

reactions{12}='12. E4P+DHAP<->SBP [BCchl]';
ecnumb{12}='4.1.2.13';
enzymes{12}='Fructose-bisphosphate aldolase';

reactions{13}='13. SBP<->S7P+Pi [BCchl]';
ecnumb{13}='3.1.3.37';
enzymes{13}='Sedoheptulose-bisphosphatase';

reactions{14}='14. F6P+GAP<->E4P+Xu5P [BCchl]';
ecnumb{14}='2.2.1.1';
enzymes{14}='Transketolase';

reactions{15}='15. S7P+GAP<->Ri5P+Xu5P [BCchl]';
ecnumb{15}='2.2.1.1';
enzymes{15}='Transketolase';

reactions{16}='16. Ri5P<->Ru5P [BCchl]';
ecnumb{16}='5.3.1.6';
enzymes{16}='Ribose-5-phosphate isomerase';

reactions{17}='17. Xu5P<->Ru5P [BCchl]';
ecnumb{17}='5.1.3.1';
enzymes{17}='Ribulose-phosphate 3-epimerase';

reactions{18}='18. Ru5P+ATP<->RuBP+ADP [BCchl]';
ecnumb{18}='2.7.1.19';
enzymes{18}='Phosphoribulokinase';

reactions{19}='19. PGA+ATP->ADP+DPGA [MCchl]';
ecnumb{19}='2.7.2.3';
enzymes{19}='Phosphoglycerate kinase';

reactions{20}='20. DPGA+NADPH->GAP+Pi+NADP [MCchl]';
ecnumb{20}='1.2.1.13';
enzymes{20}='Glyceraldehyde-3-phosphate dehydrogenase';

reactions{21}='21. F6P<->G6P, G6P<->G1P [BC]'; % Sta1 and Sta2
ecnumb{21}='5.3.1.9, 5.4.2.2';
enzymes{21}='Phosphohexomutase, Glucose phosphomutase';
...
ecnumb{23}='4.1.2.13';
enzymes{23}='Fructose-bisphosphate aldolase';

reactions{24}='24. FBP<->F6P+Pi [MC]';
ecnumb{24}='3.1.3.11';
enzymes{24}='Fructose-bisphosphatase';

reactions{25}='25. F6P<->G6P, G6P<->G1P [MC]'; %Suc6
ecnumb{25}='5.3.1.9, 5.4.2.2';
enzymes{25}='Phosphohexomutase, Glucose phosphomutase';

reactions{26}='26. G1P+UTP<->UDPG+PPi [MC]'; %Suc7
ecnumb{26}='2.7.7.9';
enzymes{26}='UTP---glucose-1-phosphate uridylyltransferase';

reactions{27}='27. UDPG+F6P<->SUCP+UDP [MC]'; %Suc8
ecnumb{27}='2.7.7.9';
enzymes{27}='xSucrose-phosphate synthase';

reactions{28}='28. SUCP<->Pi+SUC [MC]';
ecnumb{28}='3.1.3.24';
enzymes{28}='Sucrose-phosphate phosphatase';

reactions{29}='29. SUC->sink [MC]';
ecnumb{29}='Sucrose sink';
enzymes{29}='Sucrose sink';

reactions{30}='30. F6P+ATP->F26BP+ADP [MC]';
ecnumb{30}='2.7.1.105';
enzymes{30}='6-phosphofructo-2-kinase';

reactions{31}='31. F26BP[c]->F6P[c]+Pi[c] [MC]';
ecnumb{31}='3.1.3.46';
enzymes{31}='Fructose-2,6-bisphosphatase';

reactions{32}='32. ADP+Pi<->ATP [MCthy]'; % light reactions
ecnumb{32}='3.6.3.14';
enzymes{32}='ATP synthase';

reactions{33}='33. NADP<->NADPH [MCthy]'; % light reactions
ecnumb{33}='1.18.1.2';
enzymes{33}='Ferredoxin---NADP+ reductase';

reactions{34}='34. ADP+Pi<->ATP [BCthy]'; % light reactions
ecnumb{34}='3.6.3.14';
enzymes{34}='ATP synthase';

reactions{35}='35. Metabolite transport through plasmodesmata';
ecnumb{35}='';
enzymes{35}='';

reactions{36}='36. PPi + H2O <-> 2 Pi';% 
ecnumb{36}='3.6.1.1';
enzymes{36}='Inorganic phosphatase';

reactions{37}='37. NADP<->NADPH [BCthy]'; % light reactions
ecnumb{37}='1.18.1.2';
enzymes{37}='Ferredoxin-NADP+ reductase';
...
ecnumb{39}='3.1.3.18';
enzymes{39}='Phosphoglycolate phosphatase';

reactions{40}='40. GCA+O2<->H2O2+GOA [BCmit]'; % GLX==GOA
ecnumb{40}='1.1.3.15';
enzymes{40}='Glycolate oxidase';

reactions{41}='41. GOA+GLU<->GLY+KG [BCmit]';
ecnumb{41}='2.6.1.4';
enzymes{41}='Glycine transaminase';

reactions{42}='42. GLY+NAD<->SER+NADH+NH3 [BCmit]';
ecnumb{42}='1.4.4.2';
enzymes{42}='P protein, 2.1.2.1 glycine hydroxymethyltransferase';

reactions{43}='43. SER+GOA<->HPR+GLY [BCmit]';
ecnumb{43}='2.6.1.45';
enzymes{43}='Serine---glyoxylate transaminase';

reactions{44}='44. HPR+NAD<->GCEA+NADH [BCmit]';
ecnumb{44}='1.1.1.29';
enzymes{44}='Hydroxypyruvate reductase';

reactions{45}='45. GCEA+ATP<->PGA+ADP [BCmit]';
ecnumb{45}='2.7.1.31';
enzymes{45}='Glycerate 3-kinase';


reactions{46}='46. GCA[BCmit]<->GCA [BCchl]';
ecnumb{46}='GCA transport';
enzymes{46}='GCA transport';

reactions{47}='47. GCEA[BCmit]<->GCEA [BCchl]';
ecnumb{47}='GCEA transport';
enzymes{47}='GCEA transport';

reactions{48}='48. PGA<->PEP [MC]';
ecnumb{48}='5.4.2.1, 4.2.1.11';
enzymes{48}='Phosphoglycerate mutase, 2-phosphoglycerate enolase';

reactions{49}='49. PPDK inactivation [MCchl]';
ecnumb{49}='PPDK Regulatory Protein';
enzymes{49}='PPDK Regulatory Protein';

reactions{50}='50. PPDK activation [MCchl]';
ecnumb{50}='PPDK Regulatory Protein';
enzymes{50}='PPDK Regulatory Protein';

reactions{51}='51. G1P + ATP <-> PPi + ADPG [Bchl]';
ecnumb{51}='2.7.7.27';
enzymes{51}='ADPG pyrophosphorylase';

reactions{52}='52. PPi + H2O <-> 2 Pi [Bchl]';
ecnumb{52}='3.6.1.1';
enzymes{52}='Inorganic diphosphatase';

reactions{53}='53. ADPG <-> Starch [Bchl]';
ecnumb{53}='2.4.1.21';
enzymes{53}='Starch synthase';

reactions{54}='54. Hexose phosphate pool [Bchl]';
ecnumb{54}='';
enzymes{54}='';

reactions{55}='55. PGA, GAP and DHAP transport [BC]';
ecnumb{55}='Triose phosphate translocator in bundle sheath cell';
enzymes{55}='Triose phosphate translocator in bundle sheath cell';

reactions{56}='56. PGA, GAP and DHAP transport [MC]';
ecnumb{56}='Triose phosphate translocator in mesophyll cell';
enzymes{56}='Triose phosphate translocator in mesophyll cell';

reactions{57}='57. Gs dynamics [MC]';
ecnumb{57}='Dynamic stomatal conductance';
enzymes{57}='Dynamic stomatal conductance';
...
%% Used in converting the parameters to table

kmstring=cell(57,1);
for k=1:57
    temp=km(k,:);
    % temp=regexprep(temp,string(k),'');
    for i=1:10
        if ~isempty(temp{i})
            if i==1
                temp2=string(temp{i});
            else
                temp2=append(temp2,',',string(temp{i}));
            end
        end
    end
    kmstring{k}=temp2;

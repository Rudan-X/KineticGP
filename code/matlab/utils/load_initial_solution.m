function [initial_solution,KVlen]=load_initial_solution()
...
KmCO2_6 =0.0162;  KmO2_6 =0.183;  KmRuBP_6 =0.02;  KiPGA_6 =2.52;  KiFBP_6 =0.04;  KiSBP_6 =0.75;  KiPi_6 =0.9*3;  KiNADPH_6 =0.07*3;%KiNADPH_6 =0.07;KiPi_6 =0.9
...
KVlen=zeros(size(KValue,1),1);
kvalues=[];
for i=1:size(KValue,1)
    KVlen(i)=sum(KValue(i,:)~=0);
    kvalues=[kvalues,KValue(i,1:KVlen(i))];
end

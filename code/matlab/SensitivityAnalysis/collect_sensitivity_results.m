...
for acci=1:68
    for v=1:length(param_name)
        ...
        parameters_log(acci,v)=MCMCres.parameters.S.par(ind(end));
    end
end
...
data=array2table(parameters_log,"VariableNames",param_name',"RowNames",final_acc);
writetable(data,strcat(userpath,"/results/sensitivity_results/fitted_parameters_log.csv"),"WriteVariableNames",true,"WriteRowNames",true)

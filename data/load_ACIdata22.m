function [Atot,gstot,Tairtot,plotrep]=load_ACIdata22(genotype)
%%
[~,uniq_acc22,acc_plot22,~,~]=load_common_accessions22_23();

curve_data22=readtable("../data/curves/2022_ACi_rawData_maize.csv",'VariableNamingRule','preserve');
        ...
        for r=1:3
            ...
            if ~isempty(ind)
                ...
                if length(A)==11
                    ...
                    plotrep=[plotrep,strcat(string(plot_i),"_",string(r))];
                    % plot(C,A,'o')
                    % hold on

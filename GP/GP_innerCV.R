...
all_lines<-read.csv("./data/processed_data/Training68genotypes.csv")
all_lines<-all_lines$Accession


KEtype<-"equilibrator"
folder<-paste0(KEtype,"_parameters_1round")
